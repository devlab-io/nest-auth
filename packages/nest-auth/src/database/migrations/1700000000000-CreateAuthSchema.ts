      ...
      new Table({
        ...
        columns: [
          ...
          },
          {
            ...
            onUpdate: 'CURRENT_TIMESTAMP',
            isNullable: false,
            comment: 'Timestamp when the organisation was last updated',
          },
          {
            name: 'enabled',
            type: 'boolean',
            default: true,
            isNullable: false,
            comment: 'Indicates if the organisation is enabled/active',
          },
        ],
      }),
      true,
      ...
      new Table({
        ...
        columns: [
          ...
          },
          {
            ...
            onUpdate: 'CURRENT_TIMESTAMP',
            isNullable: false,
            comment: 'Timestamp when the establishment was last updated',
          },
          {
            name: 'enabled',
            type: 'boolean',
            default: true,
            isNullable: false,
            comment: 'Indicates if the establishment is enabled/active',
          },
        ],
      }),
      true,
