...
// Validate ../../app/establishments/page.tsx
{
  type __IsExpected<Specific extends AppPageConfig<'/establishments'>> =
    Specific;
  const handler = {} as typeof import('../../app/establishments/page.js');
  type __Check = __IsExpected<typeof handler>;
  // @ts-ignore
  type __Unused = __Check;
}

// Validate ../../app/organisations/page.tsx
{
  type __IsExpected<Specific extends AppPageConfig<'/organisations'>> =
    Specific;
  const handler = {} as typeof import('../../app/organisations/page.js');
  type __Check = __IsExpected<typeof handler>;
  // @ts-ignore
  type __Unused = __Check;
}
